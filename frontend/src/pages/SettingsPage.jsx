    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-zinc-950 text-zinc-100">
      ...
      <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 pb-32">
        <div className="max-w-3xl mx-auto flex flex-col gap-3">
          ...
          <form onSubmit={handleSaveSettings} className="p-4 sm:p-5 rounded-2xl bg-zinc-900/50 border border-zinc-850 flex flex-col gap-3.5">
            <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-wider flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormSettings({ ...formSettings, embeddingModel: e.target.value })}
