...
export default function SearchFilterBar({
  ...
  const tagActiveBadgeClasses: Record<string, string> = {
  ...
  const focusBorderClass = focusBorderClasses[accentColor] || 'focus:border-emerald-500/50';
  const tagActiveBadgeClass =
    tagActiveBadgeClasses[accentColor] ||
