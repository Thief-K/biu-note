...
const applyThemeDOM = (themeValue) => {
  if (typeof document === 'undefined') return;
  const isDark = themeValue === 'dark' || (themeValue === 'system' && typeof window !== 'undefined' && window.matchMedia('(prefers-color-scheme: dark)').matches);
